    ...
    return (
        <section className="w-full">
            <div className="container w-full px-20 py-20">
                <ul className="flex flex-wrap items-center gap-10 justify-between w-full">
                    <li className="bg-[#f4f4f4] overflow-hidden relative w-96 full h-full py-16">
                    ...
                    <li className="bg-[#f4f4f4] overflow-hidden relative w-96 h-full py-16">
